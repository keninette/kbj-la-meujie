...
// todo use reaflow
// todo auto volume
// todo fix awful 94% width on last chapter
// todo refactor code
// todo use index for keys
  ...
  if (chapter) {
    ...
    if (stepsPerLevel) {
      for(const level in stepsPerLevel) {
        ...
        organizedStepContent.push((<div className="flex" key={level}>{content}</div>))
              ...
              <section className="flex h-full w-full flex-grow">
                <div className="flex flex-col h-full w-full m-4">
                  ...
                  {<div className="flex flex-col">
                    ...
                    {nextChapterData && (
                      <div id="next-chapter" className="flex w-[94%] p-4 text-xl justify-center m-auto mt-10 border-solid border-2 flex-grow z-10 border-gradient border-gradient--red--to-right">
